...
[changelog](https://ocaml.org/releases/4.04/notes/Changes). There
...
For a comprehensive list of changes and details on all new features,
bug fixes, optimizations, etc., please consult the
[changelog](https://ocaml.org/releases/4.04/notes/Changes).
...
The [INSTALL](https://ocaml.org/releases/4.04/notes/INSTALL.adoc)
...
[Windows release
notes](https://ocaml.org/releases/4.04/notes/README.win32.adoc).

- [Cygwin-based native Win32
  port](https://web.archive.org/web/20170713222239/http://protz.github.io/ocaml-installer). A self
...
- [browsed
  online](https://ocaml.org/releases/4.04/htmlman/index.html),

- downloaded as a single
  [PostScript](https://ocaml.org/releases/4.04/ocaml-4.04-refman.ps.gz),
  [PDF](https://ocaml.org/releases/4.04/ocaml-4.04-refman.pdf),
  or [plain
  text](https://ocaml.org/releases/4.04/ocaml-4.04-refman.txt)
  document,

- downloaded as a single
  [TAR](https://ocaml.org/releases/4.04/ocaml-4.04-refman-html.tar.gz)
  or
  [ZIP](https://ocaml.org/releases/4.04/ocaml-4.04-refman-html.zip)
  archive of HTML files,

- downloaded as a single
  [tarball](https://ocaml.org/releases/4.04/ocaml-4.04-refman.info.tar.gz)
  of Emacs info files,
