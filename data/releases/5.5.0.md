...
is_latest: true
intro: |
  This page describes OCaml version **5.5.0**, released on
  2026-06-19. Go [here](/releases) for a list of all releases.

  This release is available as an [opam](/p/ocaml/5.5.0) package.
highlights: |
...
The source code for OCaml 5.5.0 is also directly available on:

- [GitHub](https://github.com/ocaml/ocaml/archive/5.5.0.tar.gz)
...
- [Source
  tarball](https://github.com/ocaml/ocaml/archive/5.5.0.tar.gz)
  (`.tar.gz`) for compilation under Unix (including Linux and macOS X)
  and Microsoft Windows (including Cygwin)
- Also available in
  [`.zip`](https://github.com/ocaml/ocaml/archive/5.5.0.zip)
  format
