...
The [INSTALL](https://ocaml.org/releases/3.12/notes/INSTALL)
...
release
notes](https://ocaml.org/releases/3.12/notes/README.win32).
...
* downloaded as a single
 [PostScript](https://ocaml.org/releases/3.12/ocaml-3.12-refman.ps.gz),
 [PDF](https://ocaml.org/releases/3.12/ocaml-3.12-refman.pdf),
 or [plain
 text](https://ocaml.org/releases/3.12/ocaml-3.12-refman.txt)
 document,
* downloaded as a single
 [TAR](https://ocaml.org/releases/3.12/ocaml-3.12-refman.html.tar.gz)
 or
 [ZIP](https://ocaml.org/releases/3.12/ocaml-3.12-refman.html.zip)
 archive of HTML files,
* downloaded as a single
 [tarball](https://ocaml.org/releases/3.12/ocaml-3.12-refman.info.tar.gz)
 of Emacs `info` files.
