...
[changelog](https://ocaml.org/releases/4.05/notes/Changes). There
...
The [INSTALL](https://ocaml.org/releases/4.05/notes/INSTALL.adoc)
file of the distribution provides detailed compilation and
installation instructions -- see also the [Windows release
notes](https://ocaml.org/releases/4.05/notes/README.win32.adoc) for instructions on how to build under Windows.
...
- [browsed
  online](https://ocaml.org/releases/4.05/htmlman/index.html),

- downloaded as a single
  [PostScript](https://ocaml.org/releases/4.05/ocaml-4.05-refman.ps.gz),
  [PDF](https://ocaml.org/releases/4.05/ocaml-4.05-refman.pdf),
  or [plain
  text](https://ocaml.org/releases/4.05/ocaml-4.05-refman.txt)
  document,

- downloaded as a single
  [TAR](https://ocaml.org/releases/4.05/ocaml-4.05-refman-html.tar.gz)
  or
  [ZIP](https://ocaml.org/releases/4.05/ocaml-4.05-refman-html.zip)
  archive of HTML files,

- downloaded as a single
  [tarball](https://ocaml.org/releases/4.05/ocaml-4.05-refman.info.tar.gz)
  of Emacs info files,
