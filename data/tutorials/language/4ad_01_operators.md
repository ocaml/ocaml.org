...
The complete list of precedence is longer because it includes the predefined operators that are not allowed to be used as custom operators. The OCaml Manual has a [table](/api/Ocaml_operators.html) that sums up the operator operator associativity rules.
