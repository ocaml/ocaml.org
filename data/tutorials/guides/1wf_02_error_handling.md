...
[`Stdlib`](/manual/latest/api/Stdlib.html). Here are a few examples:
...
- [Module **`option`**](/manual/latest/api/Option.html) in OCaml Library
- [Module **`result`**](/manual/latest/api/Result.html) in Ocaml Library
