...
You are encouraged to update as soon as you see fit, to continue to get package updates: opam 2.0.0 supports the older formats, and 1.2.2 will no longer get regular updates. See the [Upgrade Guide](https://opam.ocaml.org/2.0-preview/doc/Upgrade_guide.html - [404 Not Found]) for details about the new features and changes.
