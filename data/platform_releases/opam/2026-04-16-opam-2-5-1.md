...
* Fix a string injection from the depexts field to nix-build, when `os-family=nixos`. *Thanks to [@RyanGibb](https://github.com/RyanGibb) for this contribution and [@andrew](https://github.com/andrew) for the report.* ([#6894](https://github.com/ocaml/opam/pull/6894))
