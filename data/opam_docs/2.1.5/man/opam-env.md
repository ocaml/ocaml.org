---
slug: opam-env.html
title: Manpage opam-env
description: |
  man page on opam-env.
---
# OPAM-ENV
...
**opam env** \[*OPTION*\]… <span id="lbAD"> </span>
...
*-v*, add comments documenting the reason or package of origin for each
binding. This is most usefully used as **eval $(opam env)** to have
further shell commands be evaluated in the proper opam context.

This is a shortcut, and equivalent to **opam config env**.
<span id="lbAE"> </span>
