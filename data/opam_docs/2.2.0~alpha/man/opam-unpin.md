---
slug: opam-unpin.html
title: Manpage opam-unpin
description: |
  man page on opam-unpin.
---
# OPAM-UNPIN
...
opam-unpin - An alias for **pin remove**. <span id="lbAC"> </span>

## SYNOPSIS

**opam unpin** \[*OPTION*\]… \[*ARG*\]… <span id="lbAD"> </span>

## DESCRIPTION

**opam** **unpin** is an alias for **opam** **pin remove**.

See **opam** **pin --help** for details. <span id="lbAE"> </span>
