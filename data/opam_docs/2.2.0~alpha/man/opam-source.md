---
slug: opam-source.html
title: Manpage opam-source
description: |
  man page on opam-source.
---
# OPAM-SOURCE
...
**opam source** \[*OPTION*\]… *PACKAGE* <span id="lbAD"> </span>

## DESCRIPTION

Downloads the source for a given package to a local directory for
development, bug fixing or documentation purposes.
<span id="lbAE"> </span>
...
## OPTIONS
  ...
  - **--dev-repo**  
    Get the latest version-controlled source rather than the release
    archive
  - **--dir**=*DIR*  
    The directory where to put the source.
  - **--no-switch**  
    Choose package without consideration for the current (or any other)
