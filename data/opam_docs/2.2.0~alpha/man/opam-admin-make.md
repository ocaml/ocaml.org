---
slug: opam-admin-make.html
title: Manpage opam-admin-make
description: |
  man page on opam-admin-make.
---
# OPAM ADMIN-MAKE
...
opam admin-make - An alias for **index**. <span id="lbAC"> </span>

## SYNOPSIS

**opam admin make** \[**--full-urls-txt**\] \[**--minimal-urls-txt**\]
\[**--no-urls-txt**\] \[*OPTION*\]… <span id="lbAD"> </span>

## DESCRIPTION

**opam admin** **make** is an alias for **opam admin** **index**.

See **opam admin** **index --help** for details.
<span id="lbAE"> </span>
