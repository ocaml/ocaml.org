---
slug: opam-admin-lint.html
title: Manpage opam-admin-lint
description: |
  man page on opam-admin-lint.
---
# OPAM ADMIN-LINT
...
**opam admin lint** \[*OPTION*\]… \[*INT*\]… <span id="lbAD"> </span>

## DESCRIPTION

This command gathers linting results on all files in a repository. The
