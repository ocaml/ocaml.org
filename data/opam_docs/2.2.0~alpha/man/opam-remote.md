---
slug: opam-remote.html
title: Manpage opam-remote
description: |
  man page on opam-remote.
---
# OPAM-REMOTE
...
opam-remote - An alias for **repository**. <span id="lbAC"> </span>

## SYNOPSIS

**opam remote** \[**--kind**=*KIND*\] \[**--rank**=*RANK*\]
\[**--short**\] \[*OPTION*\]… \[*COMMAND*\] \[*ARG*\]…
<span id="lbAD"> </span>

## DESCRIPTION

**opam** **remote** is an alias for **opam** **repository**.

See **opam** **repository --help** for details. <span id="lbAE"> </span>
...
## Index
  ...
  - [SCOPE SPECIFICATION OPTIONS](#lbAE)
