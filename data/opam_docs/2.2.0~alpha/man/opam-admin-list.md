---
slug: opam-admin-list.html
title: Manpage opam-admin-list
description: |
  man page on opam-admin-list.
---
# OPAM ADMIN-LIST
...
**opam admin list** \[**--environment**=*VAR=VALUE\[,VAR=VALUE\]*\]
...
installation. <span id="lbAE"> </span>
...
opam [admin](../man1/admin.1.html)(1) <span id="lbAQ"> </span>
