---
slug: opam-clean.html
title: Manpage opam-clean
description: |
  man page on opam-clean.
---
# OPAM-CLEAN
...
opam-clean - Cleans up opam caches <span id="lbAC"> </span>

## SYNOPSIS

**opam clean** \[*OPTION*\]… <span id="lbAD"> </span>

## DESCRIPTION

Cleans up opam caches, reclaiming some disk space. If no options are
specified, the default is **--logs --download-cache --switch-cleanup**.
<span id="lbAE"> </span>

## OPTIONS

  - **-a**, **--all-switches**  
    Run the switch cleanup commands in all switches. Implies
    **--switch-cleanup**
  - **-c**, **--download-cache**  
  ...
  - **-r**, **--repo-cache**  
    Clear the repository cache. It will be rebuilt by the next opam
  ...
  - **--unused-repositories**  
    Clear any configured repository that is not used by any switch nor
    the default.
...
[opam](../man1/opam.1.html)(1) <span id="lbAN"> </span>
