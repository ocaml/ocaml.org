---
slug: opam-upgrade.html
title: Manpage opam-upgrade
description: |
  man page on opam-upgrade.
---
# OPAM-UPGRADE
...
**opam upgrade** \[*OPTION*\]… \[*PACKAGES*\]… <span id="lbAD"> </span>
...
directory is selected for upgrade. <span id="lbAE"> </span>
