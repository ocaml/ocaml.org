---
slug: opam-exec.html
title: Manpage opam-exec
description: |
  man page on opam-exec.
---
# OPAM-EXEC
...
Execute *COMMAND* with the correct environment variables. This command
can be used to cross-compile between switches using **opam config exec
--switch=SWITCH -- COMMAND ARG1 ... ARGn**. Opam expansion takes place
in command and args. If no switch is present on the command line or in
the *OPAMSWITCH* environment variable, *OPAMSWITCH* is not set in
