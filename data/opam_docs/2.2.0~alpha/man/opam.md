...
opam - source-based package management <span id="lbAC"> </span>

## SYNOPSIS

**opam** \[*COMMAND*\] … <span id="lbAD"> </span>

## DESCRIPTION

Opam is a package manager. It uses the powerful mancoosi tools to handle
dependencies, including support for version constraints, optional
dependencies, and conflict management. The default configuration binds
it to the official package repository for OCaml.
...
Use either **opam \<command\> --help** or **opam help \<command\>** for
more information on a specific command. <span id="lbAE"> </span>
...
## COMMANDS
  ...
  - **var** \[**--global**\] \[**--package**=*PACKAGE*\] \[*OPTION*\]…
    \[*VAR\[=\[VALUE\]\]*\]  
...
## COMMAND ALIASES
  ...
  - **info** \[*OPTION*\]… \[*PACKAGES*\]…  
    An alias for **show**.
  - **remote** \[**--kind**=*KIND*\] \[**--rank**=*RANK*\]
    \[**--short**\] \[*OPTION*\]… \[*COMMAND*\] \[*ARG*\]…  
    An alias for **repository**.
  - **search** \[**--check**\] \[**--no-depexts**\] \[**--silent**\]
    \[*OPTION*\]… \[*PATTERNS*\]…  
    An alias for **list --search**.
  - **uninstall** \[*OPTION*\]… \[*PACKAGES*\]…  
    An alias for **remove**.
  - **unpin** \[*OPTION*\]… \[*ARG*\]…  
