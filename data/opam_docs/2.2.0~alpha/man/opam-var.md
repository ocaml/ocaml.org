---
slug: opam-var.html
title: Manpage opam-var
description: |
  man page on opam-var.
---
# OPAM-VAR
...
**opam var** \[**--global**\] \[**--package**=*PACKAGE*\] \[*OPTION*\]…
\[*VAR\[=\[VALUE\]\]*\] <span id="lbAD"> </span>

## DESCRIPTION

Without argument, lists the opam variables currently defined. With a
*VAR* argument, prints the value associated with *VAR*. Otherwise, sets
or updates *VAR*'s value. If no scope is given, it acts on switch
variables by default. This command does not perform any variable
expansion. <span id="lbAE"> </span>

## ARGUMENTS

  - *VAR\[=\[VALUE\]\]*  
    If only *VAR* is given, displays its associated value. If *VALUE* is
    absent, *VAR*'s value is removed. Otherwise, its value is
    overwritten.
