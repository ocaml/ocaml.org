---
slug: opam-admin-add-hashes.html
title: Manpage opam-admin-add-hashes
description: |
  man page on opam-admin-add-hashes.
---
...
**opam admin add-hashes** \[**--packages**=*PACKAGES*\]
\[**--replace**\] \[*OPTION*\]… *HASH\_ALGO*… <span id="lbAD"> </span>

## DESCRIPTION

This command scans through package definitions, and add hashes as
requested (fetching the archives if required). A cache is generated in
/home/sabine-tarides/.cache/opam-hash-cache for subsequent runs.
<span id="lbAE"> </span>
