...
RUN apk -U upgrade --no-cache && apk add --no-cache \
    # to download and install Dune Developer Preview with alpine:3.19
...
# Build project
# NOTE(sabine): for some reason, the user in ocaml/opam:alpine-3.19-ocaml-5.2 is called "opam"
