...
type image =
  ...
  ; image_link : Uri.t
        (** The URL of the site, when the channel is rendered, the image is a
            link to the site. (Note, in practice the [image_title] and
            [image_link] should have the same value as the {!channel}'s
...
type ('a, 'b) channel_t =
  { ch_title : string
        (** Mandatory. The name of the channel, for example the title of your
            web site. *)
  ; ch_link : Uri.t
