<footer class="lg:py-28 py-14">
    <div class="container-fluid">
        <div class="flex justify-between flex-wrap space-y-16 xl:space-y-0">
            <div class="xl:w-1/4">
                <img width="160" src="img/logo-footer.svg" alt="">
                <div class="py-8">Posuere sed aliquet nunc semper mauris, orci sed vulputate. Tempor tincidunt id ultrices vulputate accumsan, euismod neque odio volutpat.</div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 lg:gap-y-0">
                <ul>
                    ...
                    <li class="py-3"><a href="success-stories.php">Success Stories</a></li>
                    <li class="py-3"><a href="industrial-users.php">Industrial Users</a></li>
                    <li class="py-3"><a href="academic-users.php">Academic Users</a></li>
                    <li class="py-3"><a href="whyOCaml.php">Why OCaml</a></li>
                </ul>


                <ul>
                    <li class="text-lg font-semibold pb-3">Resources</li>
                    <li class="py-3"><a href="getting-started.php">Get Started</a></li>
                    <li class="py-3"><a href="#">Language Docs</a></li>
                    <li class="py-3"><a href="#">Books and Manuals</a></li>
                    <li class="py-3"><a href="#">Application Guides</a></li>
                </ul>


                <ul>
                    <li class="text-lg font-semibold pb-3"><a href="community.php">Community</a></li>
                    <li class="py-3"><a href="events.php">Events & Workshops</a></li>
                    <li class="py-3"><a href="news.php">News</a></li>
                    <li class="py-3"><a href="opportunities.php">Oppurtunity</a></li>
                    <li class="py-3"><a href="#">Blog</a></li>
                </ul>


                <ul>
                    <li class="text-lg font-semibold pb-3">Legal</li>
                    <li class="py-3"><a href="#">Carbon Footprint</a></li>
                    <li class="py-3"><a href="#">Privacy</a></li>
                    <li class="py-3"><a href="#">Terms</a></li>
                </ul>
            </div>
