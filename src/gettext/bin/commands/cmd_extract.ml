...
type t = { po_content : Gettext_po.t; translated : String_set.t }
...
let add_translation loc singular plural_opt domain =
  ...
  let po_content =
    ...
    | Some domain, _ -> add_translation_domain domain t.po_content translation
    | None, Some domain ->
        add_translation_domain domain t.po_content translation
    | None, None -> add_translation_no_domain t.po_content translation
  in
