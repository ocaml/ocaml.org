...
let nplurals lang =
  ...
  if List.mem lang one_form then
    1
  else if List.mem lang two_forms_1 then
    2
  else if List.mem lang two_forms_2 then
    2
...
let plural lang n =
  ...
  then
    ...
    if List.mem lang one_form then
      ...
      if n = 1 || n = 0 then 0 else 1
    else if List.mem lang three_forms_slavic then
      failwith "locale not supported yet"
    else if List.mem lang three_forms_slavic_alt then
      failwith "locale not supported yet"
    else if String.equal lang "ar" then
      failwith "locale not supported yet"
    else if String.equal lang "cs" then
      failwith "locale not supported yet"
    else if String.equal lang "cy" then
      failwith "locale not supported yet"
    else if String.equal lang "ga" then
      failwith "locale not supported yet"
    else if String.equal lang "gd" then
      failwith "locale not supported yet"
    else if String.equal lang "is" then
      failwith "locale not supported yet"
    else if String.equal lang "jv" then
      failwith "locale not supported yet"
    else if String.equal lang "kw" then
      failwith "locale not supported yet"
    else if String.equal lang "lt" then
      failwith "locale not supported yet"
    else if String.equal lang "lv" then
      failwith "locale not supported yet"
    else if String.equal lang "mk" then
      failwith "locale not supported yet"
    else if String.equal lang "mn" then
      failwith "locale not supported yet"
    else if String.equal lang "mt" then
      failwith "locale not supported yet"
    else if String.equal lang "pl" then
      failwith "locale not supported yet"
    else if String.equal lang "ro" then
      failwith "locale not supported yet"
    else if String.equal lang "sl" then
      failwith "locale not supported yet"
    else
      raise (Unknown_language lang)
