                ...
                <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div className="mt-12 md:mt-0">
                            ...
                            <ul className="mt-4 space-y-4">
                                <li><A href="/play/resource/releases" className="text-base text-gray-500 hover:text-gray-900">{s(text["releases"])}</A></li>
                                <li><A href="/play/resource/applications" className="text-base text-gray-500 hover:text-gray-900">{s(text["applications"])}</A></li>
                                <li><A href="/play/resource/language" className="text-base text-gray-500 hover:text-gray-900">{s(text["language"])}</A></li>
                                <li><A href="/play/resource/archive" className="text-base text-gray-500 hover:text-gray-900">{s(text["archive"])}</A></li>
                            </ul>
                        </div>
                    </div>
                    <div className="md:grid md:grid-cols-2 md:gap-8">
