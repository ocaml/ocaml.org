        ...
        <div className="max-w-lg w-full md:max-w-xs">
          ...
          <form id="searchform" method="get" action="https://duckduckgo.com/">
            ...
            <div className="relative">
              ...
              <input id="search" name="q" className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-orangedark focus:border-orangedarker sm:text-sm" placeholder=content.search type_="search" />
            </div>
          </form>
        </div>
      </div> 
