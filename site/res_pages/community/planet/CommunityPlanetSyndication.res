  ...
  <div>
    <nav role="navigation" ariaLabel="Table of Contents">
      ...
      <ul>
        ...
        <li>
          <LINK href="#how-to-syndicate-your-feed"> {s(`How to syndicate your feed`)} </LINK>
        </li>
        <li>
          <LINK href="#how-to-read-planet-from-your-rss-reader">
            {s(`How to read planet from your RSS reader`)}
          </LINK>
        </li>
      </ul>
    </nav>
    <div>
      ...
      <ul>
        ...
        <li>
          <LINK href="http://alan.petitepomme.net/cwn/index.html"> {s(`Caml Weekly News`)} </LINK>
        </li>
        <li> {s(`...`)} </li>
      </ul>
      ...
      <h2 id="how-to-read-planet-from-your-rss-reader">
        {s(`How to read planet from your RSS reader`)}
      </h2>
      <p> {s(`We provide the following kinds of feed:`)} </p>
      <ul>
