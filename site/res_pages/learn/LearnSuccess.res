...
module LeftNav = {
  ...
  let make = () => {
    ...
    <ul>
      ...
      <li><LINK href="#the-mldonkey-peer-to-peer-client">{s(`The MLdonkey peer-to-peer client`)}</LINK></li>
      <li><LINK href="#lexifis-modeling-language-for-finance">{s(`LexiFi's Modeling Language for Finance`)}</LINK></li>
      <li><LINK href="#the-coq-proof-assistant">{s(`The Coq Proof Assistant`)}</LINK></li>
      <li><LINK href="#the-astree-static-analyzer">{s(`The ASTRÉE Static Analyzer`)}</LINK></li>
  ...
  <div>
    ...
    <div>
      <h1>{s(`Success Stories`)}</h1>
        ...
        <h2 id="lexifis-modeling-language-for-finance">{s(`LexiFi's Modeling Language for Finance`)}</h2>
