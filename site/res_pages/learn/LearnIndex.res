...
module IMG = {
  @react.component
  let make = (~src) =>
    <img src className="float-left mr-2 mb-1"/> 
}
  ...
  <>
    ...
    <div className="flex space-x-8 mb-5">
        ...
        <div className="flex-1"> 
            ...
            <IMG src="/static/jane-street.jpeg" />
            </LINK>
        ...
        <div className="flex-1"> 
            ...
            <IMG src="/static/lexifi-thumb.jpeg"/>
            </LINK>
            <P>
                {s(`Developed by `)}
            ...
            <P>
                ...
                <span className="font-mono border border-gray-400 bg-gray-100 rounded px-1 pt-1">{s(`genfft`)}</span>
