      ...
      <div className="pr-16 sm:text-center sm:px-16">
        <p className="font-medium text-white">
          ...
          <span className="block sm:ml-2 sm:inline-block">
            <a href="https://www.figma.com/file/36JnfpPe1Qoc8PaJq8mGMd/V1-Pages-Next-Step?node-id=931%3A6483" className="text-white font-bold underline"> {s(`View in Figma >>`)} </a>
          </span>
        </p>
      </div>
    </div>
