...
let default = () => <>
  ...
  <UL>
    <li>
      ...
      <AEXT href="http://www.meetup.com/ocaml-paris/events/188634632/">
        {React.string(`Rencontre d'été`)}
      </AEXT>
      {React.string(`, Mozilla Paris, 16 boulevard Montmartre 75009 Paris. Organized by `)}
      <AEXT href="http://www.meetup.com/ocaml-paris/">
        {React.string(`OCaml Users in PariS (OUPS)`)}
      </AEXT>
      {React.string(`.`)}
    </li>
    <li>
      {React.string(`2014, May 22, 7:00 PM: `)}
      <AEXT href="http://www.meetup.com/ocaml-paris/events/181647232/">
        {React.string(`Rencontre de Printemps`)}
      </AEXT>
    ...
    <li>
      ...
      <AEXT href="http://www.meetup.com/ocaml-paris/events/116100692/">
        {React.string(`Rencontre de Mai`)}
      </AEXT>
      {React.string(`, IRILL 23, avenue d'Italie 75013 Paris. Organized by `)}
      <AEXT href="http://www.meetup.com/ocaml-paris/">
        {React.string(`OCaml Users in PariS (OUPS)`)}
    ...
    <li>
      ...
      <AEXT href="http://www.meetup.com/ocaml-paris/events/99222322/">
        {React.string(`First "OPAM Party"`)}
      </AEXT>
      {React.string(`, IRILL 23, avenue d'Italie 75013 Paris. Organized by `)}
      <AEXT href="http://www.meetup.com/ocaml-paris/">
        {React.string(`OCaml Users in PariS (OUPS)`)}
    ...
    <li>
      {React.string(`2011: `)} <LINK href="/meetings/ocaml/2011/"> {React.string(`Paris`)} </LINK>
    </li>
    <li>
      {React.string(`2010: `)} <LINK href="/meetings/ocaml/2010/"> {React.string(`Paris`)} </LINK>
    </li>
    <li>
      {React.string(`2009: `)}
    ...
    <li>
      {React.string(`2008: `)} <LINK href="/meetings/ocaml/2008/"> {React.string(`Paris`)} </LINK>
    </li>
  </UL>
  <H2> {React.string(`In Japan`)} </H2>
  <UL>
    <li>
      {React.string(`2013: `)} <AEXT href="http://ocaml.jp/um2013"> {React.string(`Nagoya`)} </AEXT>
    </li>
    <li>
      {React.string(`2010: `)} <AEXT href="http://ocaml.jp/um2010"> {React.string(`Nagoya`)} </AEXT>
    </li>
    <li> {React.string(`2010: Tokyo`)} </li>
  </UL>
  ...
  <UL>
    ...
    <li>
      ...
      <AEXT href="http://www.meetup.com/sv-ocaml/">
        {React.string(`Silicon Valley OCaml meetups`)}
      </AEXT>
    </li>
  </UL>
  ...
  <UL>
    <li>
      {React.string(`2012: `)}
      <AEXT href="http://www.meetup.com/Cambridge-NonDysFunctional-Programmers/">
        {React.string(`Cambridge NonDysFunctional Programmers`)}
      </AEXT>
    </li>
  </UL>
</>
